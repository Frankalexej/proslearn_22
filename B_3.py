...
from model_trainer import ReconstructionTrainer as ThisTrainer
...
def run_once_continue(hyper_dir, model_type="large", pretype="f", posttype="f", sel="full", preepochs=20, postepochs=20, configs={}): 
    ...
    mylist = ["1", "2", "3", "4"]   # we have 4 tones in Mandarin, Tone 5 deleted. 
    mymap = TokenMap(mylist)

    # Trainer
    trainer = ThisTrainer(model=model, 
                           criterion=criterion, 
                           optimizer=optimizer, 
