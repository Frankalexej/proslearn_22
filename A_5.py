...
A5: 
A5 is based on A3, but adapted according to A2 to English set. 
"""
...
def run_once_eval_only(hyper_dir, model_type="large", pretype="f", posttype="f", sel="full", preepochs=20, postepochs=20, configs={}): 
    ...
    # train_losses.save()
    # valid_losses.save()def draw_learning_curve_and_accuracy_nonfull(losses, accs, epoch="", best_val=None, save=False, save_name=""): 
    plt.clf()
    fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 4))
    low_valid_losses, high_valid_losses = losses
    low_valid_accs, high_valid_accs = accs
...
if __name__ == "__main__": 
    ...
    for run_time in range(RUN_TIMES):
        ...
        if args.dataprepare: 
            ...
            mylist = ["0", "1", "2"]   # the three stress types in English
            mymap = TokenMap(mylist)
